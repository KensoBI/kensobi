...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to KensoBI',
    subheading: 'The steps below will guide you to quickly finish setting up your KensoBI installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your KensoBI installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info: 'This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
  ...
  },
  {
    ...
    subheading:
      'All necessary steps to use KensoBI are done. Now tackle advanced steps or make the best use of this home dashboard – it is, after all, a fully customizable dashboard – and remove this panel.',
    title: 'Advanced',
