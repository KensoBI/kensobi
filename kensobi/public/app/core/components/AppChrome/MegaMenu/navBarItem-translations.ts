...
export function getNavSubTitle(navId: string | undefined) {
  switch (navId) {
    ...
    case 'plugins':
      return t('nav.plugins.subtitle', 'Extend the KensoBI experience with plugins');
    case 'org-settings':
      return t('nav.org-settings.subtitle', 'Manage preferences across an organization');
    case 'apikeys':
      return t('nav.api-keys.subtitle', 'Manage and create API keys that are used to interact with KensoBI HTTP APIs');
    case 'serviceaccounts':
      return t('nav.service-accounts.subtitle', 'Use service accounts to run automated workloads in KensoBI');
    case 'global-users':
      return t('nav.global-users.subtitle', 'Manage users in KensoBI');
    case 'global-orgs':
      return t('nav.global-orgs.subtitle', 'Isolated instances of KensoBI running on the same server');
    case 'server-settings':
      return t('nav.server-settings.subtitle', 'View the settings defined in your KensoBI config');
    case 'storage':
    ...
    case 'apps':
      return t('nav.apps.subtitle', 'App plugins that extend the KensoBI experience');
    case 'monitoring':
